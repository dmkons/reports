...
\input{solution/solution-architecture/branch-controller.tex}
\newpage

\subsection{Control Unit}

\input{solution/solution-architecture/control-unit.tex}
\newpage

\subsection{Program Counter Circuit}

\input{solution/solution-architecture/program-counter-circuit.tex}
\newpage

\subsection{Multiplexer}

\input{solution/solution-architecture/multiplexer.tex}
\newpage
