...
The processor uses dedicated DSP\todo{what is DSP} slices on the FPGA to speed up the performance of the ALU.\todo{does it? have we disabled dsp slices in the syntesize menu?}
